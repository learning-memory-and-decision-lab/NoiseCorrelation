...
% step 2 = show that with a hidden layer that contains 4 task relevant
% conjunctions we can "produce" the sorts of correlations that they see in
% cohen/newsome -- and allows faster learning?

% step 3 = try to learn the 4 hidden units with error driven learning (eg.
% backpropagation).

% step 1 = do basic x,y,+,- task encoding with 2 layers...
% OK, starting from the original code:


% Ran big simulation with no normalization (10000 repetitions):
...
chooseMax       =false;  % Use greedy action selection, with perfect task bias. 
makeSchem       =false;
...
relCorrWorkspace='abstractCorrsWorkspace_corrType1_18-Apr-2021.mat'
irrelCorrWorkspace='abstractCorrsWorkspace_corrType2_18-Apr-2021.mat'
